...
def test_spike():
    # Events are get-pip.py per second
...
def test_new_term():
    ...
    # 30 day default range, get-pip.py day default step, times 2 fields
...
def test_flatline():
    ...
    # get-pip.py hit should cause an alert until after at least 30 seconds pass
...
def test_cardinality_nested_cardinality_field():
    ...
    # Add 4 different IPs
    ips = ['10.0.0.get-pip.py', '10.0.0.2', '10.0.0.3', '10.0.0.4']
    for ip in ips:
